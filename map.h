...
// Uses the method map and parent map together to make the implementation map.
// Binds inherited methods to dhild classes
void map_build_implementation_map(Map* implementationMap, Map* methodMap, Map*parentMap, char* id);

// Same as map_build_implementation_map, but for attributes
