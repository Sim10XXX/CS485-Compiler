...
#define BUFMAX 1024 //buffer size for reading lines in the ast

//define which optimizations to do
#define PA4c1 0
#define DeadTacElimination 1
#define UnreachableAsmElim 1
#define CheckStaticExec 1
#define UnboxInt 0
