...
Write a semantic analyzer that traverses the abstract syntax tree (AST) given by the parser, determine if the program complies with the Cool type system, and output the class map, implementation map, parent map, and annotated AST

The full assignment details can be found here https://kelloggm.github.io/martinjkellogg.com/teaching/cs485-sp25/projects/pa2.html
